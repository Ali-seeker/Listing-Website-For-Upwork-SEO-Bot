    ...
    data: [
      {
        ...
        slug: 'senior-full-stack-developer-nextjs',
        category: 'Engineering',
        shortDesc: 'Lead our web platform engineering using React and Node.js.',
      ...
      },
      {
        ...
        slug: 'ux-ui-designer-saas-dashboard',
        category: 'Design',
        shortDesc: 'Revamp our internal SaaS dashboard. Figma experience required.',
      ...
      },
      {
        ...
        slug: 'freelance-technical-writer-ai',
        category: 'Content',
        shortDesc: 'Produce high-quality articles on AI and Machine Learning.',
        ...
        budget: 5000,
        skills: ['Technical Writing', 'AI', 'Machine Learning'],
        client: 'AI Insights Blog',
      }
    ],
    skipDuplicates: true,
  });
